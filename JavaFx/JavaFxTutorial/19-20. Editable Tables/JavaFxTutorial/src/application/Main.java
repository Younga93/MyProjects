...
//JavaFX Java GUI Tutorial - 19&20 - Editable Tables
...
public class Main extends Application
{
	...
	{
		window = primaryStage;
		window.setTitle("19&20 - Editable Tables");
	...
	public void deleteButtonClicked() {
		ObservableList<Product> productSeleted, allProducts;
		allProducts = table.getItems();
		productSeleted = table.getSelectionModel().getSelectedItems();
